...
@interface _CustomSwizzleHelperWK : UIView
@property (nonatomic, copy) WKWebView *webView;
@end
@implementation _CustomSwizzleHelperWK
...
- (WKWebViewConfiguration *)setUpWkWebViewConfig
{
  ...
  [wkWebViewConfig.userContentController addScriptMessageHandler:[[RNCCustomWeakScriptMessageDelegate alloc] initWithDelegate:self]
...
- (void)didMoveToWindow
{
  ...
  [fillr trackWebview:self.webView];
}
...
-(void)setHideKeyboardAccessoryView:(BOOL)hideKeyboardAccessoryView
{
    ...
    NSString* name = [NSString stringWithFormat:@"%@_CustomSwizzleHelperWK", subview.class.superclass];
    ...
    if(newClass == nil)
    {
        ...
        Method method = class_getInstanceMethod([_CustomSwizzleHelperWK class], @selector(inputAccessoryView));
...
@implementation RNCCustomWeakScriptMessageDelegate
